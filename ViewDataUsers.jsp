...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
   <h1><a href="index.html" class="style5">Efficient Fair Payment Based on Blockchain for Outsourcing Services in Cloud Computing</a><a href="index.html"></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
         <h1 align="center" class="style4">View Workers...</h1>
         <p>&nbsp;</p>
  <table width="924" border="1" align="center">
  <tr>
    <td width="241" height="32" bgcolor="#FF0000"><div align="center" class="style6">User Image </div></td>
    <td width="168" bgcolor="#FF0000"><div align="center" class="style6">User Name </div></td>
...
String ii="";
      	try 
	{
           ...
           String query="select * from user where cloudname='"+a+"' "; 
