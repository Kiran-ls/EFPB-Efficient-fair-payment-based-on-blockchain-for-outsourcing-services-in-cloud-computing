...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
        <h2 align="center" class="style6">OS File Details...</h2>
           <table width="965" border="1" align="center">
  <tr>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style5">File Name </div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" class="style5">OS Name </div></td>     
       <td width="293" bgcolor="#FF0000"><div align="center" class="style5">Cloud Name </div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" class="style5">VM</div></td>
    <td width="115" bgcolor="#FF0000"><div align="center" class="style5">Date </div></td>
  </tr>
<%
String clo=(String)application.getAttribute("onname");
      	...
      	try 
	{
      		...
      		String query="select * from cloudserver where ownername='"+clo+"' "; 
...
<tr>
	...
	<td>
	<div align="center" class="style7"><%=s5%></div>	</td>
	<td>
	<div align="center" class="style7"><%=s6%></div>	</td>
	<td>
	<div align="center" class="style7"><%=s10%></div>	</td>
</tr>
