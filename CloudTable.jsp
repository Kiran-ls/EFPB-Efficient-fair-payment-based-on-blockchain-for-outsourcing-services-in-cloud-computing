...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
           <h1 align="center" class="style7">Cloud Details..</h1>
</div>
<div id="bodymiddlePanj">
  ...
  <tr>
   <td width="140" height="32" bgcolor="#FFFF00"><div align="center" class="style6"><span class="style3">File Name </span></div></td>
      ...
      <td width="293" bgcolor="#FFFF00"><div align="center" class="style6"><span class="style3">MAC</span></div></td>
    <td width="178" bgcolor="#FFFF00"><div align="center" class="style6"><span class="style3">Secret Key </span></div></td>
...
String clo=(String)application.getAttribute("ocl");
      	...
      	try 
	{
      		...
      		String query="select * from ownerdetails where cname='"+clo+"' "; 
