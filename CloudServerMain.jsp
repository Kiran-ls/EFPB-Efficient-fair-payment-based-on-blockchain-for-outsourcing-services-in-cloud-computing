...
%>
          ...
          <div>
            <p align="center">&nbsp;</p>
            <p align="center"><img src="images/gal1.jpg" width="648" height="302" /></p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
           ...
           <div class="clr"></div>
          <ul class="sb_menu">
		    <li><a href="ViewDataOwners.jsp">View All Outsourcers</a></li>
			
			<li><a href="ViewDataUsers.jsp">View All Workers</a></li>
            <li><a href="GetThreshold.jsp">View Cloud Threshold</a></li>
            ...
            <li><a href="ViewCloudFiles.jsp">View All Files</a></li>
  			...
  			<li><a href="UnblockUser.jsp">UnRevoke User</a></li>
			<li><a href="Results1.jsp">View Time Delay</a></li>
			<li><a href="Results2.jsp">View Throughput</a></li>
