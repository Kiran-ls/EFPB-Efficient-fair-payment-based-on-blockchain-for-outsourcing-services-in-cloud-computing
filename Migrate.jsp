...
.style13 {font-size: 16px; color: #FFFF00; font-style: italic; font-family: Arial, Helvetica, sans-serif; }
-->
</style>
</head>
<body>
...
<table width="598" border="1" align="center">
	...
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style13">Provide Ur Email id:-
		</span></td>
		<td width="356"><input name="email" type="text" id="t42"
			size="50" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style13">Provide Ur Reg UserName:-
		</span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style13">Migrating From :- </span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style7">
		  <label for="cloud">Migration to :- </label>
		</span></td>
