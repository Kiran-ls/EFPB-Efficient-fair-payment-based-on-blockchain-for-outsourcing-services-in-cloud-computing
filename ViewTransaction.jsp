...
<table width="598" border="0" align="center">
	...
	<p>&nbsp;</p>
	<tr>
		<td bgcolor="#FF0000" class="style5">Enter Cloud Name :-</td>
...
<table width="965" border="1" align="center">
	<tr>
		...
		<div align="center" class="style7"><span class="style3">Name </span></div>		</td>
		<td width="140" height="32" bgcolor="#FF0000">
		<div align="center" class="style7"><span class="style3">File Name </span></div>		</td>
		<td width="293" bgcolor="#FF0000">
		<div align="center" class="style7"><span class="style3">Cloud Name </span></div>		</td>
		<td width="293" bgcolor="#FF0000">
		<div align="center" class="style7"><span class="style3">Secret Key</span></div>		</td>
		<td width="115" bgcolor="#FF0000">
		<div align="center" class="style7"><span class="style3">Task</span></div>		</td>
		<td width="115" bgcolor="#FF0000">
		<div align="center" class="style7"><span class="style3">Date </span></div>		</td>
	</tr>
...
String transaction=request.getParameter("tran");
      	...
      	try 
	{
      		...
      		String query="select * from transaction where task='"+transaction+"'"; 
