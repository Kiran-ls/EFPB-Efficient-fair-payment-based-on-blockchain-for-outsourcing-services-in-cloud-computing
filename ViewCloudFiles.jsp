...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
    <h2 align="center" class="style7">Cloud Files....</h2>
        <p align="center">&nbsp;</p>
        <table width="965" border="1" align="center">
  <tr>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style6">File Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style6">Owner Name </div></td>
         <td width="293" bgcolor="#FF0000"><div align="center" class="style6">Cloud Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style6">Virtual Machine  </div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" class="style6">MAC</div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style6">Secret Key </div></td>
    <td width="115" bgcolor="#FF0000"><div align="center" class="style6">Rank </div></td>
    <td width="205" bgcolor="#FF0000"><div align="center" class="style6">Date & Time</div></td>
  </tr>
...
String cn=(String) application.getAttribute("cloudName");
      	try 
	{
      		...
      		String query="select * from CloudServer where cname='"+cn+"' "; 
  ...
  <tr>
    ...
    <td><div align="center" class="style7"><%=s4%></div></td>
	  ...
	  <td><div align="center" class="style7"><%=s9%></div></td>
    	  <td><div align="center" class="style7"><%=s10%></div></td>
  </tr>
