...
<div id="bodymiddlePanj">
  ...
  <tr>
   <td width="140" height="32" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">File Name </span></div></td>
      <td width="293" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Owner Name </span></div></td>     
       <td width="293" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Cloud Name </span></div></td>
      <td width="293" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">MAC</span></div></td>
    <td width="178" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Secret Key </span></div></td>
    <td width="115" bgcolor="#FFFF00"><div align="center" class="style5"><span class="style3">Date </span></div></td>
  </tr>
<%
